...
import com.sci.models.Price;
import com.sci.models.PriceCompositeKey;
...
public class DBPrice {
    public List<Price> getByFilter(List<FilterQuery> filterQueries) {
        ...
        try (Session session = DBConfig.SESSION_FACTORY.openSession()) {
            ...
            Root<Price> root = cr.from(Price.class);
            ...
            Query<Price> query = session.createQuery(cr);
    ...
    public PriceCompositeKey create(Price price) {
    ...
    public void delete(String roomNumber, String season, String weekday) {
